...
export default function Timeline() {
  ...
  return (
    <section id="timeline" className="py-24 md:py-36 bg-white border-t border-[#B9965B]/15 relative overflow-hidden">
      
      {/* Decorative vertical gold wash */}
      <div className="absolute left-1/2 top-0 bottom-0 w-[0.5px] bg-[#B9965B]/15 pointer-events-none hidden md:block" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-20">
          <div className="lg:col-span-8 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#1C1814] tracking-wider leading-tight">
              ...
              <span className="italic font-light text-[#B9965B]">From Intention to Return.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="border border-[#B9965B]/15 p-2 bg-white relative group shadow-2xl">
              <div className="aspect-[4/3] sm:aspect-video lg:aspect-[1/1] overflow-hidden relative">
                ...
                {/* Text Indicator overlay - kept bright on dark gradient for optimal readability */}
                <div className="absolute bottom-6 left-6 right-6 space-y-2.5 text-left">
                  ...
                  <h4 className="text-xl font-serif text-white tracking-wider uppercase">
                    {TIMELINE_STEPS[activeStep].title}
                  </h4>
                  <p className="text-xs text-white/80 font-sans font-light tracking-wide leading-relaxed">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-6 border transition-all duration-500 flex items-start gap-6 select-none ${
                    isActive
                      ? "border-[#B9965B] bg-[#FAF7F2] shadow-lg"
                      : "border-[#B9965B]/15 bg-[#FAF7F2]/40 hover:border-[#B9965B]/25 hover:bg-white"
                  }`}
                >
                  {/* Step Index Circle */}
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center font-mono text-xs font-bold transition-all duration-500 ${
                      isActive
                        ? "bg-[#B9965B] text-white scale-105"
                        : "bg-[#B9965B]/10 text-[#1C1814]/40"
                    }`}
                  >
                    {st.step}
                  </div>
                  ...
                  <div className="space-y-1.5 flex-grow">
                    ...
                    <h3
                      className={`text-sm tracking-[0.15em] font-medium transition-colors ${
                        isActive ? "text-[#1C1814]" : "text-[#1C1814]/70"
                      }`}
                    >
                      {st.title}
                    </h3>
                    ...
                    >
                      <p className="text-xs text-[#1C1814]/75 font-sans font-light tracking-wide leading-relaxed">
                        {st.description}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-2">
                    <ChevronRight
                      ...
                      className={`transition-transform duration-300 ${
                        isActive ? "text-[#B9965B] rotate-90" : "text-[#1C1814]/20"
                      }`}
                    />
                  </div>
                </button>
        ...
        <div className="hidden lg:grid grid-cols-5 gap-4 pt-24 border-t border-[#B9965B]/15 mt-20 relative">
          <div className="absolute top-24 left-0 right-0 h-[1px] bg-[#B9965B]/20 z-0" />
                ...
                <div
                  className={`absolute -top-1 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full border transform -translate-y-[1px] transition-all duration-500 ${
                    isActive
                      ...
                      : "bg-white border-[#B9965B]/30 group-hover:border-[#B9965B]/60"
                  }`}
                />

                <span className="text-[9px] font-mono tracking-wider text-[#B9965B]/65 font-semibold block mb-2">
                  0{idx + 1}
                </span>

                <h4
                  className={`text-[11px] font-sans font-bold tracking-[0.2em] uppercase transition-colors duration-300 ${
                    isActive ? "text-[#B9965B]" : "text-[#1C1814]/50 group-hover:text-[#1C1814]"
                  }`}
                >
                  {st.title}
                </h4>
